...
const Cart = () => {
  ...
  useEffect(() => {
    alanBtn({
      key: '6ee8f84eb979442c3b11263241d190bf2e956eca572e1d8b807a3e2338fdd0dc/stage',
  ...
  return (
    <div className="album py-5 bg-light">
      <div className="container">
            <div className='fixed-top m-1 position-relative' style={{textAlign: 'center'}}>
                <h1>AI voice E-commerse website</h1>
            </div>
